...
Issues live in GitHub Issues (`themattwick/claude-code-genesis`). See `docs/agents/issue-tracker.md`.
...
Single-context layout, but routed through `BRAIN/` instead of `CONTEXT.md` /
`docs/adr/`: decisions live in `BRAIN/decisions/`, domain terms in
`BRAIN/glossary/`. See `docs/agents/domain.md`.
