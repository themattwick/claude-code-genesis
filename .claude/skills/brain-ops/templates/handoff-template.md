...
- Tests to run
- Reports to read
- Decisions waiting for review/approval

---
**Goal of this document:** The receiving model should be able to continue productive work within 10 minutes without having to re-discover context.
